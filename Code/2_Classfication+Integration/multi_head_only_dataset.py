...
class LSTMWithMultiheadAttention(nn.Module):
    ...
    def forward(self, input):
        ...
        # print(hidden.shape)
        context_vector, attention_weights = self.attention(hidden, encoder_outputs, encoder_outputs)
...
class ProtAlbertClassifier(pl.LightningModule):
    ...
    def __build_model(self) -> None:
        ...
        self.classification_head = nn.Sequential(
            ...
            LSTMWithMultiheadAttention(input_size=512, hidden_size=512, num_layers=5,num_heads=4),
            LSTMFlatten(),
