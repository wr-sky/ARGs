...
class MS_dataset:
    ...
    def load_dataset(self, path):
        ...
        for i in range(len(self.scaled_data)):
            ...
            self.dict = {"emb": self.vector.view(-1, 2560), "label": self.label}
...
class ProtAlbertClassifier(pl.LightningModule):
    ...
    def __build_model(self) -> None:
        ...
        self.hidden_size_4 = 2048

        self.classification_head = nn.Sequential(

            LSTMWithLuongAttention(input_size=2560, hidden_size=512, num_layers=5),
            LSTMFlatten(),
            ...
            nn.InstanceNorm1d(num_features=self.hidden_size_4),
            nn.Linear(self.hidden_size_4, 32),
            nn.Dropout(p=0.356),
            # nn.Softmax(dim=-1),
        )
    ...
    def add_model_specific_args(
        ...
        parser.add_argument(
            "--train_csv",
            default="/data/newdisk/mrj_data/resistance/data/train_data_2.pkl",
            type=str,
            help="Path to the file containing the train data.",
        )
        parser.add_argument(
            "--dev_csv",
            default="/data/newdisk/mrj_data/resistance/data/val_data_2.pkl",
            type=str,
            help="Path to the file containing the dev data.",
        )
        parser.add_argument(
            "--test_csv",
            default="/data/newdisk/mrj_data/resistance/data/test_data_2.pkl",
            type=str,
            help="Path to the file containing the dev data.",
        )
...
# Batching
parser.add_argument("--batch_size", default=200, type=int, help="Batch size to be used.")
parser.add_argument(
