...
class MS_dataset:
    ...
    def load_dataset(self, path):
        ...
        for i in range(len(self.strain_vector)):
            ...
            self.strain_dict = {"emb": scaled_emb.view(1, -1, 512), "label": self.strain_label}
...
class ProtAlbertClassifier(pl.LightningModule):
    ...
    def __build_model(self) -> None:
        ...
        self.classification_head = nn.Sequential(
            # nn.Conv1d(in_channels=10, out_channels=30, kernel_size=3, stride=1, padding=0),
            # nn.GELU(),
            # nn.Conv1d(in_channels=30, out_channels=1, kernel_size=3, stride=1, padding=0),
            # nn.GELU(),
            # nn.Dropout(p=0.3),
    ...
    def training_step(self, batch, batch_nb, *args, **kwargs) -> dict:
        ...
        model_out = self.forward(torch.squeeze(inputs))
    ...
    def add_model_specific_args(
        ...
        parser.add_argument(
            "--train_csv",
            default="D:/D_Data/耐药/data/resistance_emb_uniform.pkl",
            type=str,
...
# Batching
parser.add_argument("--batch_size", default=2, type=int, help="Batch size to be used.")
parser.add_argument(
