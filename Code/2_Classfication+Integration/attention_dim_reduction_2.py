...
class LSTMWithMultiheadAttention_1(nn.Module):
    ...
    def forward(self, input):
        ...
        # print("context_vector_1:",context_vector_1.shape)
...
class ProtAlbertClassifier(pl.LightningModule):
    ...
    def forward_2(self, input,context_vector_1):
        # self.attention_model_2 = LSTMWithMultiheadAttention_2(input_size=2560, hidden_size=512, num_layers=6, num_heads=4)
        self.attention_model_2 = nn.LSTM(input_size=2560, hidden_size=512, num_layers=5, batch_first=True,
                                         dropout=0.356)
        self.attention_model_2 = self.attention_model_2.to("cuda")
        inputs = torch.matmul(context_vector_1,input)
        context_vector_2, attention_weights_2 = self.attention_model_2(inputs)
        self.lstmflatten = LSTMFlatten()
    ...
    def loss(self, predictions_1: dict, predictions_2: dict, targets:dict):
        ...
        return self._loss_1(predictions_1["logits"], targets)*0.2+self._loss_2(predictions_2["logits"], targets)*0.8
    ...
    def training_step(self, batch, batch_nb,optimizer_idx,*args, **kwargs) -> dict:
        ...
        model_out_2 = self.forward_2(inputs_2,context_vector_1)
