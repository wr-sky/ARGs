...
class MS_dataset:
    ...
    def load_dataset(self, path):
        ...
        for i in range(len(self.strain_vector)):
            ...
            self.strain_dict = {"emb": scaled_emb.view(1,-1, 512), "label": torch.tensor([self.strain_label])}
...
class LSTMFlatten(nn.Module):
    def forward(self, x):
        ...
        flattened_output = output.view(batch_size, -1)
...
class ProtAlbertClassifier(pl.LightningModule):
    ...
    def __build_model(self) -> None:
        ...
        self.classification_head = nn.Sequential(
            ...
            # nn.GELU(),
            # nn.Dropout(p=0.3),
            nn.LSTM(input_size=512, hidden_size=512, num_layers=12, dropout=0.456, batch_first=True),
            LSTMFlatten(),
    ...
    def add_model_specific_args(
        ...
        parser.add_argument(
            "--train_csv",
            default="/data/newdisk/mrj_data/resistance/data/resistance_emb_uniform.pkl",
            type=str,
