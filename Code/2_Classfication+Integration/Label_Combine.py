...
class MS_dataset:
    ...
    def load_dataset(self, path):
        ...
        for i in range(len(self.scaled_data)):
            ...
            self.dict = {"emb_1": self.vector_1.view(-1, 1280), "emb_2": self.vector_2.view(-1, 2560),"label": self.label}
...
class ProtAlbertClassifier(pl.LightningModule):
    ...
    def __build_model(self) -> None:
        ...
        self.classification_head_1 = nn.Sequential(
            ...
            nn.LSTM(input_size=1280, hidden_size=512, num_layers=6, batch_first=True, dropout=0.356),
            LSTMFlatten(),
    ...
    def loss(self, predictions_1: dict, predictions_2: dict, targets:dict):
        ...
        return self._loss_1(predictions_1["logits"], targets)*0.35+self._loss_2(predictions_2["logits"], targets)*0.65
    ...
    def validation_step(self, batch: tuple, batch_nb: int, *args, **kwargs) -> dict:
        ...
        for i in range(len(labels_hat_1)):
            if labels_hat_1[i] == labels_hat_2[i]:
                ...
                y_hat = y_hat_1[i]*0.65 + y_hat_2[i]*0.35
